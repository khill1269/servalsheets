...
5. **fix-agent.md** - Bug fixing with root cause analysis
...
- `phase-completion.md` - Gate pipeline with multiple agents
- `feature-implementation.md` - TDD workflow with 4 agents
