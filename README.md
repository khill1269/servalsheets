...
Production-grade Google Sheets MCP Server with 25 tools, 411 actions, safety rails, and enterprise features.
...
- ✅ **Tools**: 25 tools with 411 actions using discriminated unions
...
| ------------------ | ----------------- | ----------------------- | ------------------------ |
| **full** (default) | 411/411           | Self-hosted, enterprise | 4-6 weeks                |
...
### Tool Summary (25 tools, 411 actions)
...
ServalSheets uses **Zod discriminated unions** for type-safe action dispatch across 25 tools and 411 actions. This architecture provides:
...
| **Tools**        | ✅ Full | 2025-11-25 | 25 tools, 411 actions, discriminated unions |
