...
function generateAdvancedTestData(): TestDataSpec[] {
  return [
    // Named ranges (5)
    {
      ...
      args: { action: 'add_named_range', spreadsheetId: TEST_SPREADSHEET_ID, name: 'TestRange', range: 'A1:B10' },
    ...
    },
    {
      ...
      args: { action: 'update_named_range', spreadsheetId: TEST_SPREADSHEET_ID, namedRangeId: 'test-id', name: 'UpdatedRange' },
    ...
    },
    {
      ...
      args: { action: 'delete_named_range', spreadsheetId: TEST_SPREADSHEET_ID, namedRangeId: 'test-id' },
    ...
    },
    {
      ...
      args: { action: 'update_protected_range', spreadsheetId: TEST_SPREADSHEET_ID, protectedRangeId: 12345 },
    ...
    },
    {
      ...
      args: { action: 'delete_protected_range', spreadsheetId: TEST_SPREADSHEET_ID, protectedRangeId: 12345 },
    ...
    // Metadata (3)
    {
      tool: 'sheets_advanced',
      action: 'set_metadata',
      args: { action: 'set_metadata', spreadsheetId: TEST_SPREADSHEET_ID, metadataKey: 'testKey', metadataValue: 'testValue' },
    ...
    },
    {
      tool: 'sheets_advanced',
      action: 'delete_table',
      args: { action: 'delete_table', spreadsheetId: TEST_SPREADSHEET_ID, tableId: 'test-table-id' },
    ...
    // Smart Chips (4)
    {
      ...
      args: { action: 'add_person_chip', spreadsheetId: TEST_SPREADSHEET_ID, range: 'A1', email: 'test@example.com' },
    ...
    },
    {
      ...
      args: { action: 'add_drive_chip', spreadsheetId: TEST_SPREADSHEET_ID, range: 'A1', fileId: 'test-file-id' },
    ...
    },
    {
      ...
      args: { action: 'add_rich_link_chip', spreadsheetId: TEST_SPREADSHEET_ID, range: 'A1', uri: 'https://example.com' },
...
function generateTransactionTestData(): TestDataSpec[] {
  return [
    ...
    },
    {
      tool: 'sheets_transaction',
      action: 'queue',
      args: { action: 'queue', transactionId: 'tx-123', operation: { tool: 'sheets_data', action: 'read', params: { range: 'A1:B10' } } },
...
function generateQualityTestData(): TestDataSpec[] {
  return [
    ...
    },
    {
      ...
      args: { action: 'resolve_conflict', spreadsheetId: TEST_SPREADSHEET_ID, conflictId: 'conflict-123', resolution: 'keep_newer' },
    ...
    },
    {
      ...
      args: { action: 'analyze_impact', spreadsheetId: TEST_SPREADSHEET_ID, operation: { tool: 'sheets_data', action: 'write', params: { range: 'A1', values: [['test']] } } },
...
function generateHistoryTestData(): TestDataSpec[] {
  return [
    ...
    },
    {
      tool: 'sheets_history',
      action: 'get_snapshot',
      args: { action: 'get_snapshot', spreadsheetId: TEST_SPREADSHEET_ID, snapshotId: 'snapshot-123' },
    ...
    },
    {
      ...
      args: { action: 'create_snapshot', spreadsheetId: TEST_SPREADSHEET_ID, description: 'Manual checkpoint' },
    ...
    },
    {
      tool: 'sheets_history',
      action: 'compare',
      args: { action: 'compare', spreadsheetId: TEST_SPREADSHEET_ID, fromSnapshotId: 'snapshot-1', toSnapshotId: 'snapshot-2' },
  ...
  return [
    {
      tool: 'sheets_confirm',
      action: 'request',
      args: { action: 'request', operation: { tool: 'sheets_data', action: 'clear', params: { spreadsheetId: TEST_SPREADSHEET_ID, range: 'Sheet1' } }, reason: 'This will clear all data' },
    ...
    },
    {
      tool: 'sheets_confirm',
      action: 'wizard_start',
      args: { action: 'wizard_start', wizardType: 'create_spreadsheet', context: { title: 'New Spreadsheet' } },
    ...
    },
    {
      tool: 'sheets_confirm',
      action: 'wizard_step',
      args: { action: 'wizard_step', wizardId: 'wiz-123', stepId: 'step-1', response: { confirmed: true } },
...
function generateAnalyzeTestData(): TestDataSpec[] {
  return [
    ...
    },
    {
      ...
      args: { action: 'suggest_visualization', spreadsheetId: TEST_SPREADSHEET_ID, range: 'Sheet1!A1:D100' },
    ...
    },
    {
      ...
      args: { action: 'detect_anomalies', spreadsheetId: TEST_SPREADSHEET_ID, range: 'Sheet1!A1:D100' },
    ...
    },
    {
      ...
      args: { action: 'generate_formula', spreadsheetId: TEST_SPREADSHEET_ID, description: 'Calculate the sum of column A' },
    ...
    },
    {
      ...
      args: { action: 'summarize_data', spreadsheetId: TEST_SPREADSHEET_ID, range: 'Sheet1!A1:D100' },
    ...
    },
    {
      ...
      args: { action: 'detect_patterns', spreadsheetId: TEST_SPREADSHEET_ID, range: 'Sheet1!A1:D100' },
    ...
    },
    {
      ...
      args: { action: 'compare_sheets', spreadsheetId: TEST_SPREADSHEET_ID, sourceSheet: 'Sheet1', targetSheet: 'Sheet2' },
  ...
  return [
    {
      ...
      action: 'connect',
      args: { action: 'connect', spreadsheetId: TEST_SPREADSHEET_ID, projectId: 'test-project', datasetId: 'test_dataset', tableId: 'test_table' },
    ...
    },
    {
      ...
      args: { action: 'connect_looker', spreadsheetId: TEST_SPREADSHEET_ID, projectId: 'test-project', datasetId: 'test_dataset', tableId: 'test_table' },
    ...
    },
    {
      ...
      args: { action: 'get_connection', spreadsheetId: TEST_SPREADSHEET_ID, dataSourceId: 'ds-123' },
    ...
    },
    {
      tool: 'sheets_bigquery',
      action: 'query',
      args: { action: 'query', spreadsheetId: TEST_SPREADSHEET_ID, dataSourceId: 'ds-123', query: 'SELECT * FROM table LIMIT 10' },
    ...
    },
    {
      tool: 'sheets_bigquery',
      action: 'preview',
      args: { action: 'preview', spreadsheetId: TEST_SPREADSHEET_ID, dataSourceId: 'ds-123', query: 'SELECT * FROM table LIMIT 5' },
    ...
    },
    {
      ...
      args: { action: 'cancel_refresh', spreadsheetId: TEST_SPREADSHEET_ID, dataSourceId: 'ds-123' },
    ...
    },
    {
      ...
      args: { action: 'export_to_bigquery', spreadsheetId: TEST_SPREADSHEET_ID, range: 'Sheet1!A1:D10', projectId: 'test-project', datasetId: 'test_dataset', tableId: 'export_table' },
    ...
    },
    {
      ...
      args: { action: 'import_from_bigquery', spreadsheetId: TEST_SPREADSHEET_ID, projectId: 'test-project', datasetId: 'test_dataset', tableId: 'test_table', sheetName: 'Imported' },
    ...
    },
    {
      ...
      args: { action: 'create_extract', spreadsheetId: TEST_SPREADSHEET_ID, dataSourceId: 'ds-123', range: 'A1:D100' },
    ...
    },
    {
      ...
      args: { action: 'update_extract', spreadsheetId: TEST_SPREADSHEET_ID, dataSourceId: 'ds-123' },
...
function generateTemplatesTestData(): TestDataSpec[] {
  return [
    ...
    },
    {
      ...
      args: { action: 'save_as_template', spreadsheetId: TEST_SPREADSHEET_ID, name: 'My Template', description: 'Test template' },
...
function generateAppsScriptTestData(): TestDataSpec[] {
  return [
    ...
    },
    {
      ...
      args: { action: 'update_content', scriptId: 'test-script-id', files: [{ name: 'Code', type: 'SERVER_JS', source: 'function test() {}' }] },
    ...
    },
    {
      ...
      args: { action: 'create_trigger', scriptId: 'test-script-id', functionName: 'onEdit', triggerType: 'ON_EDIT' },
