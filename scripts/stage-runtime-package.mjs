...
const runtimePackageJson = {
  ...
  dependencies: {
    ...
    '@serval/mcp-client': 'file:packages/mcp-client',
    '@serval/mcp-http': 'file:packages/mcp-http',
    '@serval/mcp-runtime': 'file:packages/mcp-runtime',
    '@serval/mcp-stdio': 'file:packages/mcp-stdio',
  },
