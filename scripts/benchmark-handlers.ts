...
console.log(
  `  Speedup: ${(switchResult.avgNs / mapResult.avgNs).toFixed(1)}x\n`,
);
...
console.log(
  `  Speedup: ${(jsonKeyResult.avgNs / fastKeyResult.avgNs).toFixed(1)}x\n`,
);
...
console.log(
  `  Speedup: ${(reduceCellResult.avgNs / forLoopCellResult.avgNs).toFixed(1)}x\n`,
);
...
console.log(
  `  Speedup: ${(largeReduceResult.avgNs / largeForLoopResult.avgNs).toFixed(1)}x\n`,
);
...
console.log(
  `  Speedup: ${(objectAssignResult.avgNs / spreadResult.avgNs).toFixed(1)}x\n`,
);
