 ...
 *
 * Tests all 21 tools with sample inputs and validates:
 * - Tool registration
 * - Schema validation
 * - Handler execution
 * - Response structure
...
async function runTests() {
  ...
  // Test 6: sheets_visualize
  await testTool('sheets_visualize', {
  ...
  // Test 7: sheets_collaborate
  await testTool('sheets_collaborate', {
  ...
  // Test 10: sheets_quality
  await testTool('sheets_quality', {
    name: 'sheets_quality',
    arguments: {
      action: 'validate',
      value: 'test',
