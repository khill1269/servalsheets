...
hero:
  ...
  tagline: Production-grade integration with 407 actions, safety rails, and AI-powered features
  image:
    src: /logo.svg
    alt: ServalSheets
  actions:
...
features:
  - icon: 🎯
    ...
    details: Full compliance with MCP 2025-11-25 specification. 25 tools, 407 actions, resources, and prompts.
  - icon: 🛡️
    title: Safety Rails
