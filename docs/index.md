...
hero:
  ...
  tagline: Production-grade integration with 267 actions, safety rails, and AI-powered features
  image:
    src: /logo.svg
    alt: ServalSheets
  actions:
...
features:
  - icon: 🎯
    ...
    details: Full compliance with MCP 2025-11-25 specification. 22 tools, 267 actions, 6 resources, 6 prompts.
  - icon: 🛡️
    title: Safety Rails
