...
| Section | Score | Max |
|---------|-------|-----|
| Part 1: Functional | ___% | 46% |
| Part 2: Protocol | ___% | 18% |
| Part 3: Code Quality | ___% | 36% |
| Part 4: Deep Technical (Bonus) | ___% | +20% |
| Part 5: Excellence (Bonus) | ___% | +20% |
| **Total** | **____%** | **140%** |
...
|-------|----------|--------|
| Build | Exit 0 | ___ |
| Typecheck | 0 errors | ___ |
| Tests | 1,830+ pass | ___ |
| Coverage | ≥75% | ___% |
