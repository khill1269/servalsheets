...
- 📊 294 actions covering 100% of Sheets API v4
...
| ----------------- | ------------------------ | ---------------------- |
| Tools             | ✅ 21 tools, 294 actions | ❌ Not MCP             |
...
- Need comprehensive API coverage (294 actions)
...
- 294 actions covering the complete Sheets API
