...
- 📊 293 actions covering 100% of Sheets API v4
...
| ----------------- | ------------------------ | ---------------------- |
| Tools             | ✅ 21 tools, 293 actions | ❌ Not MCP             |
...
- Need comprehensive API coverage (293 actions)
...
- 293 actions covering the complete Sheets API
