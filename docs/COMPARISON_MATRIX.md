...
| **Actions/Operations**   | 267                | ~30       | ~10        | Unlimited          | ~20         |
...
- 📊 267 actions covering 100% of Sheets API v4
...
| ----------------- | ------------------------ | ---------------------- |
| Tools             | ✅ 22 tools, 267 actions | ❌ Not MCP             |
...
- Need comprehensive API coverage (267 actions)
...
- 267 actions covering the complete Sheets API
