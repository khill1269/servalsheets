...
| Tool Design             | ✅ Excellent    | 21 tools, 294 actions, discriminated unions  |
...
ServalSheets groups 294 actions into **21 logical tool categories** using discriminated unions:
...
**Issue:** The skill loaded by Claude at `/mnt/skills/user/google-sheets-expert/` contains outdated information ("111 tools") that doesn't match the actual implementation (21 tools, 294 actions).
...
└── references/
    ├── tool-guide.md           # Complete 21 tools, 294 actions reference
