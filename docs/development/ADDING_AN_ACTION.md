...
📊 Analyzing 22 schema files...
  ...
  ...
✅ Total: 25 tools, 399 actions (was 299)
...
Modified (GENERATED - do not edit manually):
  package.json - Description now says "399 actions"
  src/schemas/index.ts - ACTION_COUNT = 399
...
Modified:
  ...
  package.json (description: 299 → 399 actions)
  src/schemas/index.ts (ACTION_COUNT = 399)
...
❌ Metadata drift detected in 2 files:
  - src/schemas/index.ts (expected ACTION_COUNT = 399, found 299)
  - package.json (expected "399 actions", found "399 actions")
```
