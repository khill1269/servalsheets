...
**Note**: SKILL.md is specifically written for AI assistants to understand how to use the 25 tools and 408 actions. It includes best practices, safety guidelines, and common patterns.
