...
**Note**: SKILL.md is specifically written for AI assistants to understand how to use the 22 tools and 342 actions. It includes best practices, safety guidelines, and common patterns.
