...
**If you get TypeScript errors:** See [DEBUGGING.md](./DEBUGGING.md)
...
- **[Debugging Guide](./DEBUGGING.md)** - TS and runtime troubleshooting
...
1. **Read architecture docs:**
   ...
   - [Durable Schema Pattern](../development/DURABLE_SCHEMA_PATTERN.md)
