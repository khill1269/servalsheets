...
| **ACTION_COUNT** | `src/schemas/action-counts.ts` | exported constant | `391`         | `grep "export const ACTION_COUNT" src/schemas/action-counts.ts` |
...
```
Claim: ServalSheets has 391 actions
Evidence: src/schemas/action-counts.ts exports ACTION_COUNT = 391
...
ServalSheets has 391 actions across 25 tools.
Evidence: src/schemas/action-counts.ts exports ACTION_COUNT = 391
```
