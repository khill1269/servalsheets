...
| sheets_fix         | FixHandler              | handlers/fix.ts (1241 lines)         | 6       | CleaningEngine, quality validators |
...
| sheets_confirm      | ConfirmHandler                         | handlers/confirm.ts (455 lines)      | 5       | ElicitationServer, WizardSessions                |
...
| sheets_compute      | ComputeHandler                         | handlers/compute.ts (1608 lines)     | 16      | ComputeEngine (stats, regression, forecast)      |
| sheets_connectors   | ConnectorsHandler                      | handlers/connectors.ts (859 lines)   | 10      | ConnectorManager (external API connector registry) |
