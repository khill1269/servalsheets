...
description: Debugging and troubleshooting guide for ServalSheets contributors
version: 1.7.0
...
1. **Check documentation** - [ONBOARDING.md](../development/ONBOARDING.md), [SOURCE_OF_TRUTH.md](../development/SOURCE_OF_TRUTH.md)
