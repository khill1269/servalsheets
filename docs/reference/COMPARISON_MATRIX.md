...
- 📊 305 actions covering 100% of Sheets API v4
...
| ----------------- | ------------------------ | ---------------------- |
| Tools             | ✅ 22 tools, 305 actions | ❌ Not MCP             |
...
- Need comprehensive API coverage (305 actions)
...
- 305 actions covering the complete Sheets API
