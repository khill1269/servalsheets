...
- 📊 299 actions covering 100% of Sheets API v4
...
| ----------------- | ------------------------ | ---------------------- |
| Tools             | ✅ 22 tools, 299 actions | ❌ Not MCP             |
...
- Need comprehensive API coverage (299 actions)
...
- 299 actions covering the complete Sheets API
