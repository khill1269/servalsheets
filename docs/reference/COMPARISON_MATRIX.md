...
- 📊 342 actions covering 100% of Sheets API v4
...
| ----------------- | ------------------------ | ---------------------- |
| Tools             | ✅ 22 tools, 342 actions | ❌ Not MCP             |
...
- Need comprehensive API coverage (342 actions)
...
- 342 actions covering the complete Sheets API
