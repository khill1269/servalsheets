...
- 📊 391 actions covering 100% of Sheets API v4
...
| ----------------- | ------------------------ | ---------------------- |
| Tools             | ✅ 25 tools, 391 actions | ❌ Not MCP             |
...
- Need comprehensive API coverage (391 actions)
...
- 391 actions covering the complete Sheets API
