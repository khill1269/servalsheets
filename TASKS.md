...
- [ ] **18-X13**: Progress coverage phase-2 tranche E — continue handler audit for remaining long-running actions without incremental progress feedback and add tests per instrumented action.
