...
|---------|--------|----------------|
| Tools (25 tools, 407 actions) | ✅ | `src/generated/action-counts.ts` |
...
| Completions (407 actions) | ✅ | `src/generated/completions.ts` (1,391 lines) |
...
3. **Cache-invalidation graph** (`src/services/cache-invalidation-graph.ts`, 805 lines): Operation-based invalidation for 407 actions
...
```
servalsheets/
├── src/                    — Main MCP server (25 tools, 407 actions)
├── packages/
