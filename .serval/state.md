...
> Generated: 2026-03-15 08:55:01 UTC
...
| Last Commit  | aa2a043 chore(tasks): mark P17-06 complete — npm run verify fully green |
| Working Tree | 23 uncommitted files                                                    |
...
| File                         | Size       |
| ---------------------------- | ---------- |
| src/server.ts                | 1436 lines |
| src/http-server.ts           | 976 lines  |
| src/handlers/base.ts         | 1613 lines |
