  ...
  beforeEach(() => {
    ...
    mockSheetsGet.mockResolvedValue({
      data: {
        ...
        namedRanges: [
          { name: "Revenue", range: { sheetId: 0, startRowIndex: 0, endRowIndex: 10, startColumnIndex: 1, endColumnIndex: 2 } },
          { name: "Expenses", range: { sheetId: 0, startRowIndex: 0, endRowIndex: 10, startColumnIndex: 2, endColumnIndex: 3 } },
        ],
      },
    });
