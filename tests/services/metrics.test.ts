...
describe("MetricsService", () => {
  ...
  describe("recordOperation", () => {
    it("should record successful operation", () => {
      service.recordOperation("sheets_values.read", 100, true);

      const metrics = service.getOperationMetrics("sheets_values.read");
    ...
    it("should record failed operation", () => {
      service.recordOperation("sheets_values.read", 50, false);
    ...
    it("should track duration statistics", () => {
      service.recordOperation("sheets_values.read", 100, true);
      service.recordOperation("sheets_values.read", 200, true);
      service.recordOperation("sheets_values.read", 150, true);
