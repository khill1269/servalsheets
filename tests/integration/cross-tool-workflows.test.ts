...
/**
 * Cross-Tool Schema Validation: Create Formatted Spreadsheet
 *
 * Validates schema compatibility across sheets_core, sheets_data, sheets_format
 * Schema validation only (no handler chain execution).
 * Steps validated:
...
/**
 * Cross-Tool Schema Validation: Create Chart from Data
 *
 * Validates schema compatibility across sheets_data, sheets_visualize
 * Schema validation only (no handler chain execution).
 * Steps validated:
 ...
 */
describe('Cross-Tool Schema Validation: Create Chart from Data', () => {
