...
describe('Handler Performance Benchmarks', () => {
  ...
  describe('sheets_core Handler', () => {
    bench('get spreadsheet metadata', async () => {
    ...
    bench('create spreadsheet', async () => {
      await handlers.core.executeAction({
        request: {
          action: 'create',
    ...
    bench('batch_read (10 ranges)', async () => {
      await handlers.data.executeAction({
        request: {
          action: 'batch_read',
          spreadsheetId: 'test-spreadsheet-12345',
          ranges: Array(10).fill(null).map((_, i) => ({
  ...
  describe('Schema Validation Performance', () => {
    ...
    bench('complex input validation (batch write)', () => {
  ...
  describe('Handler Overhead', () => {
    ...
    bench('handler dispatch overhead', () => {
