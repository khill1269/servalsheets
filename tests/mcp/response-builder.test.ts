...
describe("Streaming Response", () => {
  ...
  it("should return chunks sequentially", () => {
    ...
    const response1 = (chunk1.structuredContent as Record<string, unknown>)[
      "response"
    ] as Record<string, unknown>;
  ...
  it("should mark last chunk correctly", () => {
    ...
    const response = (lastChunk.structuredContent as Record<string, unknown>)[
      "response"
    ] as Record<string, unknown>;
  ...
  it("should include metadata in first chunk", () => {
    ...
    const response = (chunk.structuredContent as Record<string, unknown>)[
      "response"
    ] as Record<string, unknown>;
