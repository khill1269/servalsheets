 ...
 */
export function updateCircuitBreakerMetric(circuit, state) {
 ...
 */
export function recordToolCall(tool, action, status, durationSeconds) {
 ...
 */
export function recordGoogleApiCall(method, status, durationSeconds) {
 ...
 */
export function updateQueueMetrics(size, pending) {
    queueSize.set(size);
 ...
 */
export function updateCacheMetrics(namespace, hits, misses, sizeBytes) {
 ...
 */
export function recordBatchOperation(operation, size) {
