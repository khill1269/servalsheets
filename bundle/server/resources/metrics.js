 ...
 */
export function registerMetricsResources(server) {
    const metricsService = getMetricsService();
    // Resource: metrics://summary - Complete metrics summary
    server.registerResource('Performance Metrics Summary', 'metrics://summary', {
    ...
    server.registerResource('Operation Metrics', 'metrics://operations', {
    ...
    server.registerResource('Cache Metrics', 'metrics://cache', {
    ...
    server.registerResource('API Metrics', 'metrics://api', {
    ...
    server.registerResource('System Metrics', 'metrics://system', {
    ...
    server.registerResource('Service Information', 'metrics://service', {
