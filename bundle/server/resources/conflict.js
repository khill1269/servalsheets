 ...
 */
export function registerConflictResources(server) {
    const conflictDetector = getConflictDetector();
    // Resource 1: conflict://stats - Conflict detector statistics
    server.registerResource('Conflict Detector Statistics', 'conflict://stats', {
    ...
    server.registerResource('Conflict Detector Help', 'conflict://help', {
