 ...
 */
export function registerTransactionResources(server) {
    const transactionManager = getTransactionManager();
    // Resource 1: transaction://stats - Transaction manager statistics
    server.registerResource('Transaction Manager Statistics', 'transaction://stats', {
    ...
    server.registerResource('Transaction Manager Help', 'transaction://help', {
