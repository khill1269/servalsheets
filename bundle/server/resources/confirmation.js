...
import { analyzeOperation, shouldConfirm, getConfirmationGuidance, CONFIRMATION_THRESHOLDS, } from '../services/confirmation-policy.js';
// ============================================================================
 ...
 */
export function registerConfirmationResources(server) {
    // Static resource: Confirmation guide
    server.registerResource('confirmation_guide', new ResourceTemplate('sheets:///confirmation/guide', { list: undefined }), {
...
`;
    ...
    server.registerResource('confirmation_check', checkTemplate, {
    ...
    server.registerResource('destructive_operations', new ResourceTemplate('sheets:///confirmation/destructive', {
        list: undefined,
    }), {
