...
export function registerPivotResources(server, googleClient) {
    ...
    server.registerResource('Spreadsheet Pivot Tables', pivotsTemplate, {
        title: 'Pivot Tables',
        ...
        try {
            const data = await requestDeduplicator.deduplicate(createRequestKey('pivots:list', { spreadsheetId }), async () => {
