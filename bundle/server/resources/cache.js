 ...
 */
export function registerCacheResources(server) {
    // Resource: cache://stats - Cache statistics
    server.registerResource('Cache Statistics', 'cache://stats', {
        ...
        try {
            ...
            const displaySize = stats.totalSize > 1024 * 1024 ? `${totalSizeMB} MB` : `${totalSizeKB} KB`;
            // Calculate additional metrics
            const totalRequests = stats.hits + stats.misses;
            const avgEntrySize = stats.totalEntries > 0 ? (stats.totalSize / stats.totalEntries / 1024).toFixed(2) : '0';
            // Format timestamps
    ...
    server.registerResource('Request Deduplication Statistics', 'cache://deduplication', {
                ...
                contents: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            efficiency: {
                                ...
                                performance: {
                                    rating: stats.totalSavingsRate >= 50
                                        ? 'excellent'
