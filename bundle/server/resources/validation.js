 ...
 */
export function registerValidationResources(server) {
    const validationEngine = getValidationEngine();
    // Resource 1: validation://stats - Validation engine statistics
    server.registerResource('Validation Engine Statistics', 'validation://stats', {
    ...
    server.registerResource('Validation Engine Help', 'validation://help', {
