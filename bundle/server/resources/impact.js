 ...
 */
export function registerImpactResources(server) {
    const impactAnalyzer = getImpactAnalyzer();
    // Resource 1: impact://stats - Impact analyzer statistics
    server.registerResource('Impact Analyzer Statistics', 'impact://stats', {
    ...
    server.registerResource('Impact Detector Help', 'impact://help', {
