...
export function registerQualityResources(server, googleClient) {
    ...
    server.registerResource('Data Quality Report', qualityTemplate, {
        ...
        try {
            const data = await requestDeduplicator.deduplicate(createRequestKey('quality:analyze', { spreadsheetId }), async () => {
