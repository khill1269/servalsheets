...
const analysisResultsStore = new Map();
 ...
 */
export function storeAnalysisResult(spreadsheetId, result) {
    const id = `analysis-${nextAnalysisId++}`;
    const summary = result.success && 'summary' in result
 ...
 */
export function registerAnalyzeResources(server) {
    const analysisService = getSamplingAnalysisService();
    // Resource 1: analyze://stats - Analysis service statistics
    server.registerResource('AI Analysis Statistics', 'analyze://stats', {
    ...
    server.registerResource('AI Analysis Help', 'analyze://help', {
...
`;
    ...
    server.registerResource('Analysis Results List', 'analyze://results', {
    ...
    server.registerResource('Specific Analysis Result', 'analyze://results/{id}', {
