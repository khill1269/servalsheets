 ...
 */
export function registerReferenceResources(server) {
    // Color reference - Google Sheets color system
    server.registerResource('Google Sheets Color Reference', 'servalsheets://reference/colors', {
    ...
    server.registerResource('Common Formula Patterns', 'servalsheets://reference/formulas', {
    ...
    server.registerResource('Number Format Strings', 'servalsheets://reference/number-formats', {
    ...
    server.registerResource('Google Sheets API Limits', 'servalsheets://reference/api-limits', {
        description: 'API quotas, rate limits, and size restrictions for Google Sheets operations.',
        mimeType: 'application/json',
    }, async (uri) => readReferenceResource(typeof uri === 'string' ? uri : uri.toString()));
    // Data validation patterns
    server.registerResource('Data Validation Patterns', 'servalsheets://reference/validation-patterns', {
        description: 'Common validation rules for emails, URLs, phone numbers, and custom patterns.',
        mimeType: 'application/json',
    }, async (uri) => readReferenceResource(typeof uri === 'string' ? uri : uri.toString()));
    // Chart types reference
    server.registerResource('Chart Types and Configuration', 'servalsheets://reference/chart-types', {
 ...
 */
export async function readReferenceResource(uri) {
