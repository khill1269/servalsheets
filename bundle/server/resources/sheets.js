 ...
 */
export function registerSheetResources(server, context) {
    try {
        // Register resource template for listing sheets in a spreadsheet
        server.registerResource('Available Sheets List', 'sheets://spreadsheets/{spreadsheetId}/sheets', {
        ...
        server.registerResource('Sheet Data', 'sheets://spreadsheets/{spreadsheetId}/sheets/{sheetName}', {
 ...
 */
export async function readSheetResource(uri, context) {
 ...
 */
async function listSheetsInSpreadsheet(spreadsheetId, context) {
    try {
 ...
 */
async function getSheetData(spreadsheetId, sheetName, context) {
    try {
