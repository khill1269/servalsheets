...
export const FIELD_MASKS = {
     ...
     */
    SPREADSHEET_WITH_SHEETS: 'spreadsheetId,properties,spreadsheetUrl,sheets(properties(sheetId,title,index,gridProperties(rowCount,columnCount)))',
    /**
     ...
     */
    SPREADSHEET_COMPREHENSIVE: 'spreadsheetId,properties,spreadsheetUrl,sheets(properties,merges,conditionalFormats,filterViews,protectedRanges),namedRanges,developerMetadata',
    /**
     ...
     * Size: ~500 bytes
     */
    VALUES_APPEND: 'spreadsheetId,updates(spreadsheetId,updatedCells,updatedRows,updatedColumns,updatedRange)',
    /**
 ...
 * ```
 */
export function buildFieldMask(fields) {
    return fields.join(',');
}
/**
 ...
 * ```
 */
export function combineFieldMasks(...masks) {
...
//# sourceMappingURL=field-masks.js.map