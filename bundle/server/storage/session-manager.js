...
export class SessionManager {
     ...
     */
    async createSession(sessionId, userId, metadata, ttlSeconds) {
    ...
    async addToUserIndex(userId, sessionId, ttlSeconds) {
        const sessionIds = await this.getUserSessionIds(userId);
 ...
 */
export function createSessionManager(sessionStore, options) {
