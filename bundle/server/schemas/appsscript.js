...
const DeployActionSchema = z.object({
    ...
    access: z
        ...
        .optional()
        .default('MYSELF')
        .describe('Who can access: MYSELF, DOMAIN (Workspace), ANYONE (Google account), ANYONE_ANONYMOUS'),
    executeAs: z
...
const RunActionSchema = z.object({
    ...
    parameters: z
        .array(z.unknown())
        .optional()
        .describe('Function parameters (basic types only: strings, numbers, arrays, objects, booleans)'),
    devMode: z
        .boolean()
        .optional()
        .default(false)
...
// Annotations
// ============================================================================
export const SHEETS_APPSSCRIPT_ANNOTATIONS = {
