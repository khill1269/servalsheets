...
const FindByReferenceActionSchema = CommonFieldsSchema.extend({
    ...
    reference: z
        ...
        .describe('Natural language reference like "that", "the budget", "the last write" (max 500 chars)'),
    referenceType: z
...
// Combined output - using z.union because all success responses share success: true
...
// TOOL ANNOTATIONS
// ============================================================================
export const SHEETS_SESSION_ANNOTATIONS = {
