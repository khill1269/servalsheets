 ...
 */
import { z } from 'zod';
import { A1NotationSchema, CellValueSchema, ErrorDetailSchema, ResponseMetaSchema, SafetyOptionsSchema, } from './shared.js';
// ============================================================================
// Common Schemas
// ============================================================================
const CommonFieldsSchema = z.object({
    safety: SafetyOptionsSchema.optional().describe('Safety options (dryRun to test validation rules without applying, etc.)'),
    verbosity: z
...
const DetectConflictsActionSchema = CommonFieldsSchema.extend({
    ...
    range: A1NotationSchema.optional().describe('Range to check (A1 notation) - entire sheet if omitted'),
    since: z
        .number()
        .optional()
...
const ResolveConflictActionSchema = CommonFieldsSchema.extend({
    ...
    mergedValue: CellValueSchema.optional().describe('Merged value for manual resolution strategy (required if strategy=manual)'),
});
...
export const SHEETS_QUALITY_ANNOTATIONS = {
