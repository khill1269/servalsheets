 ...
 */
import { z } from 'zod';
import { SpreadsheetIdSchema, SheetIdSchema, RangeInputSchema, ErrorDetailSchema, CellValueSchema, ResponseMetaSchema, } from './shared.js';
...
export const SheetsAnalysisInputSchema = z
    ...
    description: z
        .string()
        .optional()
        .describe('Natural language description of needed template (e.g., "project tracker", "budget planner")'),
    ...
    message: 'Missing required fields for the specified action. Check action-specific requirements.',
});
        ...
        templates: z
            ...
            suggestions: z.array(z.object({
                ...
                structure: z
                    ...
                    features: z
                        .array(z.string())
                        .describe('Recommended features (e.g., "conditional formatting", "data validation")'),
                })
                    .optional(),
...
export const SHEETS_ANALYSIS_ANNOTATIONS = {
