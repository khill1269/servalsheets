 ...
 */
import { z } from 'zod';
import { SpreadsheetIdSchema, SheetIdSchema, SheetNameSchema, ErrorDetailSchema, MutationSummarySchema, ResponseMetaSchema, SafetyOptionsSchema, } from './shared.js';
// ============================================================================
// Common Schemas
// ============================================================================
/**
...
export const ImportCsvInputSchema = z.object({
    ...
    mode: ImportCsvModeSchema.default('replace').describe('How to handle existing data (default: replace | alternatives: append, new_sheet)'),
    ...
    safety: SafetyOptionsSchema.optional().describe('Safety options: dryRun for preview, autoSnapshot for automatic backups'),
});
...
export const SmartAppendInputSchema = z.object({
    ...
    createMissingColumns: z
        .boolean()
        .default(false)
        .describe('Create columns for unmatched headers (default: false | set true to auto-create columns)'),
    skipEmptyRows: z
        .boolean()
        .default(true)
...
export const BulkUpdateInputSchema = z.object({
    ...
    createUnmatched: z
        .boolean()
        .default(false)
        .describe('Create new rows for unmatched keys (default: false | set true to insert missing rows)'),
    verbosity: z
        .enum(['minimal', 'standard', 'detailed'])
        .optional()
        .default('standard')
...
export const DeduplicateInputSchema = z.object({
    ...
    keep: DeduplicateKeepSchema.default('first').describe('Which duplicate to keep (default: first | alternative: last)'),
    preview: z
        .boolean()
        .default(false)
...
// Tool Annotations
// ============================================================================
export const SHEETS_COMPOSITE_ANNOTATIONS = {
