 ...
 */
export function buildAnalysisSamplingRequest(data, request) {
    ...
    const truncatedNote = data.length > maxRows || (data[0] && data[0].length > maxCols)
 ...
 */
export function buildFormulaSamplingRequest(description, context) {
 ...
 */
export function buildChartSamplingRequest(data, context) {
...
class SamplingAnalysisService {
     ...
     */
    recordSuccess(analysisTypes, responseTime) {
...
// Singleton instance
let samplingAnalysisService = null;
/**
 * Get the sampling analysis service instance
 */
export function getSamplingAnalysisService() {
 ...
 * @internal
 */
export function resetSamplingAnalysisService() {
...
//# sourceMappingURL=sampling-analysis.js.map