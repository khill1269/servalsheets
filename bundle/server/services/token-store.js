...
export class EncryptedFileTokenStore {
    filePath;
    key;
    constructor(filePath, secretKeyHex) {
        if (!secretKeyHex || secretKeyHex.length !== 64) {
            throw new ConfigError('TOKEN_STORE_KEY must be a 64-character hex string (32 bytes)', 'TOKEN_STORE_KEY', {
    ...
    async load() {
        try {
            ...
            if (record.version !== 1) {
                throw new DataError(`Unsupported token store version: ${record.version}`, 'VERSION_MISMATCH', false, {
