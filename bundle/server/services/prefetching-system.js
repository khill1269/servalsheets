...
export class PrefetchingSystem {
    ...
    refreshMetadata = new Map();
    // Refresh check interval (30 seconds)
    refreshCheckInterval = 30000;
    // Metrics
    stats = {
        totalPrefetches: 0,
     ...
     */
    async prefetchOnOpen(spreadsheetId) {
        if (!this.enabled)
            return;
     ...
     */
    trackRefreshMetadata(cacheKey, metadata) {
    ...
    async refreshExpiringSoon() {
        try {
            ...
            const expiringSpreadsheetEntries = cacheManager.getExpiringEntries(this.refreshThreshold, 'spreadsheet');
     ...
     */
    createRefreshTask(cacheKey, expiresIn) {
        ...
        if (metadata) {
            ...
            const priority = this.calculateRefreshPriority(metadata.accessCount, metadata.lastAccessed, expiresIn);
            return {
                cacheKey,
     ...
     */
    calculateRefreshPriority(accessCount, lastAccessed, expiresIn) {
    ...
    getStats() {
        return {
            ...
            prefetchHitRate: this.stats.totalPrefetches > 0
            ...
            refreshHitRate: this.stats.totalRefreshes > 0
...
// Singleton instance
let prefetchingSystem = null;
/**
 * Initialize the prefetching system
 */
export function initPrefetchingSystem(sheetsApi) {
 ...
 */
export function getPrefetchingSystem() {
    return prefetchingSystem;
}
/**
 ...
 * @internal
 */
export function resetPrefetchingSystem() {
...
//# sourceMappingURL=prefetching-system.js.map