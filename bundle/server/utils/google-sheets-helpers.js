 ...
 */
export function parseCellReference(cell) {
 ...
 */
export function buildA1Notation(sheetName, startCol, startRow, endCol, endRow) {
 ...
 */
export function toGridRange(input) {
    return {
 ...
 */
export function estimateCellCount(range) {
...
//# sourceMappingURL=google-sheets-helpers.js.map