 ...
 */
export function checkAuth(googleClient) {
    if (!googleClient) {
        return {
            authenticated: false,
            error: {
 ...
 */
export function buildAuthErrorResponse(error) {
    return {
        response: {
            success: false,
            error: {
 ...
 */
export function requireAuth(googleClient) {
...
export function isGoogleAuthError(error) {
    ...
    const errorMessage = error instanceof Error
        ...
        : typeof error === 'object' && error !== null && 'message' in error
            ...
            : String(error);
    return GOOGLE_AUTH_ERROR_PATTERNS.some((pattern) => errorMessage.toLowerCase().includes(pattern.toLowerCase()));
}
/**
 ...
 */
export function convertGoogleAuthError(error) {
