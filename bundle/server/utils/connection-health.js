...
export class ConnectionHealthMonitor {
    ...
    getStats() {
        ...
        return {
            ...
            uptimeSeconds: this.monitoringStarted > 0 ? Math.floor((now - this.monitoringStarted) / 1000) : 0,
            status,
 ...
 */
export function startConnectionHealthMonitoring(config) {
 ...
 */
export function stopConnectionHealthMonitoring() {
    if (healthMonitor) {
        healthMonitor.stop();
    }
}
