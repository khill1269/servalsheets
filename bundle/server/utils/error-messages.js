...
export const ERROR_MESSAGES = {
    ...
    // ========================
    SERVICE_NOT_INITIALIZED: (serviceName, method) => ({
    ...
    // Sheet Operations
    // ========================
    SHEET_NOT_FOUND: (sheetName, spreadsheetId) => ({
    ...
    RANGE_RESOLUTION_FAILED: (rangeInput) => ({
    ...
    // Configuration
    // ========================
    CONFIG_ERROR: (key, format, received) => ({
    ...
    TOKEN_STORE_KEY_INVALID: (received) => ({
    ...
    SNAPSHOT_CREATION_FAILED: (spreadsheetId, reason) => ({
    ...
    // Google API Errors
    // ========================
    GOOGLE_API_QUOTA_EXCEEDED: (quotaType) => ({
    ...
    GOOGLE_API_PERMISSION_DENIED: (spreadsheetId) => ({
    ...
    // Data Errors
    // ========================
    DATA_PARSE_ERROR: (field, expectedType) => ({
    ...
    VERSION_MISMATCH: (receivedVersion, supportedVersions) => ({
    ...
    TASK_ALREADY_TERMINAL: (taskId, status) => ({
    ...
    REDIS_REQUIRED_IN_PRODUCTION: () => ({
        ...
        details: {
            reason: 'In-memory session store does not support multiple instances or persist across restarts',
 ...
 */
export function getErrorMessage(template) {
    return {
