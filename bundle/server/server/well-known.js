 ...
 */
export function getOAuthAuthorizationServerMetadata(issuer) {
    ...
    if (isGoogleIssuer) {
        return {
            ...
            scopes_supported: [...DEFAULT_SCOPES, ...ELEVATED_SCOPES, ...READONLY_SCOPES].filter((v, i, a) => a.indexOf(v) === i), // Deduplicate
    ...
    return {
        ...
        scopes_supported: [...DEFAULT_SCOPES, ...ELEVATED_SCOPES, ...READONLY_SCOPES].filter((v, i, a) => a.indexOf(v) === i),
        response_types_supported: ['code'],
        grant_types_supported: ['authorization_code', 'refresh_token'],
        token_endpoint_auth_methods_supported: ['client_secret_post', 'client_secret_basic'],
        code_challenge_methods_supported: ['S256'],
 ...
 */
export function getOAuthProtectedResourceMetadata(serverUrl) {
    return {
        resource: serverUrl,
 ...
 */
export function mcpConfigurationHandler(req, res) {
 ...
 */
export function oauthAuthorizationServerHandler(req, res) {
 ...
 */
export function oauthProtectedResourceHandler(req, res) {
