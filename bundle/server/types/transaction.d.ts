 ...
 * Transaction status
 */
export type TransactionStatus = 'pending' | 'queued' | 'executing' | 'committed' | 'rolled_back' | 'failed';
/**
 * Operation type for transaction queuing
 */
export type OperationType = 'values_write' | 'values_append' | 'values_update' | 'format_apply' | 'sheet_create' | 'sheet_delete' | 'cell_merge' | 'cell_unmerge' | 'row_insert' | 'row_delete' | 'column_insert' | 'column_delete' | 'formula_write' | 'validation_add' | 'custom';
/**
