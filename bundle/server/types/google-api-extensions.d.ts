 ...
 */
export declare function isCellValue(value: unknown): value is string | number | boolean;
/**
 * Type guard for SheetData
 */
export declare function isSheetData(value: unknown): value is SheetData;
/**
 * Type guard for GridRange
 */
export declare function isGridRange(value: unknown): value is GridRange;
/**
 * Safe type cast for Google API responses
 */
export declare function asGoogleResponse<T>(response: unknown): GoogleSheetsResponse<T>;
//# sourceMappingURL=google-api-extensions.d.ts.map