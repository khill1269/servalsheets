 ...
 */
export type ValidationRuleType = 'data_type' | 'range' | 'format' | 'uniqueness' | 'required' | 'pattern' | 'custom' | 'business_rule';
/**
 * Validation severity
 */
 ...
 */
export type DataType = 'string' | 'number' | 'integer' | 'boolean' | 'date' | 'time' | 'datetime' | 'email' | 'url' | 'phone' | 'currency' | 'percentage';
/**
 * Validation rule
 */
