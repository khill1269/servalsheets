 ...
 * Conflict type
 */
export type ConflictType = 'concurrent_modification' | 'stale_data' | 'overlapping_range' | 'deletion_conflict' | 'format_conflict' | 'formula_conflict';
/**
 * Resolution strategy
 */
export type ResolutionStrategy = 'overwrite' | 'merge' | 'cancel' | 'manual' | 'last_write_wins' | 'first_write_wins';
/**
