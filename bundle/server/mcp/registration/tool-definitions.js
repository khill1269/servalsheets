...
import { SheetsAuthInputSchema, SheetsAuthOutputSchema, SHEETS_AUTH_ANNOTATIONS, SheetsCoreInputSchema, SheetsCoreOutputSchema, SHEETS_CORE_ANNOTATIONS, SheetsDataInputSchema, SheetsDataOutputSchema, SHEETS_DATA_ANNOTATIONS, SheetsFormatInputSchema, SheetsFormatOutputSchema, SHEETS_FORMAT_ANNOTATIONS, SheetsDimensionsInputSchema, SheetsDimensionsOutputSchema, SHEETS_DIMENSIONS_ANNOTATIONS, SheetsVisualizeInputSchema, SheetsVisualizeOutputSchema, SHEETS_VISUALIZE_ANNOTATIONS, SheetsCollaborateInputSchema, SheetsCollaborateOutputSchema, SHEETS_COLLABORATE_ANNOTATIONS, SheetsAdvancedInputSchema, SheetsAdvancedOutputSchema, SHEETS_ADVANCED_ANNOTATIONS, SheetsTransactionInputSchema, SheetsTransactionOutputSchema, SHEETS_TRANSACTION_ANNOTATIONS, SheetsQualityInputSchema, SheetsQualityOutputSchema, SHEETS_QUALITY_ANNOTATIONS, SheetsHistoryInputSchema, SheetsHistoryOutputSchema, SHEETS_HISTORY_ANNOTATIONS, 
// New MCP-native tools
SheetsConfirmInputSchema, SheetsConfirmOutputSchema, SHEETS_CONFIRM_ANNOTATIONS, SheetsAnalyzeInputSchema, SheetsAnalyzeOutputSchema, SHEETS_ANALYZE_ANNOTATIONS, SheetsFixInputSchema, SheetsFixOutputSchema, SHEETS_FIX_ANNOTATIONS, 
// Composite operations
CompositeInputSchema, CompositeOutputSchema, SHEETS_COMPOSITE_ANNOTATIONS, 
// Session context for NL excellence
SheetsSessionInputSchema, SheetsSessionOutputSchema, SHEETS_SESSION_ANNOTATIONS, 
// Tier 7 Enterprise tools
SheetsTemplatesInputSchema, SheetsTemplatesOutputSchema, SHEETS_TEMPLATES_ANNOTATIONS, SheetsBigQueryInputSchema, SheetsBigQueryOutputSchema, SHEETS_BIGQUERY_ANNOTATIONS, SheetsAppsScriptInputSchema, SheetsAppsScriptOutputSchema, SHEETS_APPSSCRIPT_ANNOTATIONS, 
// LLM-optimized descriptions
TOOL_DESCRIPTIONS, } from '../../schemas/index.js';
// ============================================================================
// TOOL DEFINITIONS
// ============================================================================
/**
 ...
 */
export const ACTIVE_TOOL_DEFINITIONS = (() => {
