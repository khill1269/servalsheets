 ...
 */
export function registerServalSheetsResources(server, googleClient) {
    ...
    server.registerResource('spreadsheet', spreadsheetTemplate, {
        title: 'Spreadsheet',
    ...
    server.registerResource('spreadsheet_range', rangeTemplate, {
