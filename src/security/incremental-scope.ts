...
// Scope data map is in a separate file to keep this module focused on logic.
// All symbols are re-exported for backwards compatibility with existing imports.
import { ScopeCategory, OPERATION_SCOPES } from './operation-scopes-map.js';
export { ScopeCategory, OPERATION_SCOPES };
