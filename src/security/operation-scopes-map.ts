/**
 * ServalSheets - Operation Scope Mappings
 *
 * Maps each tool action to its required OAuth scopes and scope category.
 * Used by ScopeValidator in incremental-scope.ts to enforce per-action permissions.
 *
 * @see src/security/incremental-scope.ts
 */
...
> = {
  ...
  'sheets_advanced.create_named_function': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Create named function',
  },
  'sheets_advanced.list_named_functions': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'List named functions',
  },
  'sheets_advanced.get_named_function': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Get named function',
  },
  'sheets_advanced.update_named_function': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Update named function',
  },
  'sheets_advanced.delete_named_function': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Delete named function',
  },
  ...
  'sheets_analyze.auto_enhance': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Auto-enhance spreadsheet',
  },
  'sheets_analyze.discover_action': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Discover applicable actions',
  },
  'sheets_analyze.formula_health_check': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Check formula health',
  },
  'sheets_analyze.quick_insights': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Get quick insights',
  },
  'sheets_analyze.diagnose_errors': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Diagnose spreadsheet errors',
  },
  'sheets_analyze.semantic_search': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Semantic search spreadsheet content',
  },
  'sheets_analyze.schedule_intelligence': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Schedule intelligence analysis',
  },
  'sheets_analyze.get_intelligence_report': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Get intelligence report',
  },
  'sheets_analyze.cancel_intelligence': {
    required: [],
    category: ScopeCategory.SPREADSHEET,
    description: 'Cancel intelligence analysis',
  },
  ...
  'sheets_core.describe_workbook': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Describe workbook structure',
  },
  'sheets_core.workbook_fingerprint': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Get workbook fingerprint',
  },
  'sheets_core.clear_sheet': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Clear sheet content',
  },
  'sheets_core.move_sheet': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Move sheet within spreadsheet',
  },
  ...
  'sheets_data.detect_spill_ranges': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Detect spill ranges',
  },
  'sheets_data.smart_fill': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Smart fill data',
  },
  ...
  'sheets_format.batch_format': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Batch apply formatting',
  },
  'sheets_format.set_rich_text': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Set rich text formatting',
  },
  'sheets_format.generate_conditional_format': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Generate conditional formatting rules',
  },
  'sheets_format.build_dependent_dropdown': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Build dependent dropdown lists',
  },
  ...
  'sheets_dimensions.duplicate_filter_view': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Duplicate filter view',
  },
  ...
  'sheets_collaborate.label_apply': {
    required: ['https://www.googleapis.com/auth/drive'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Apply label to spreadsheet',
  },
  'sheets_collaborate.label_remove': {
    required: ['https://www.googleapis.com/auth/drive'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Remove label from spreadsheet',
  },
  ...
  'sheets_fix.suggest_cleaning': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Suggest cleaning actions',
  },
  ...
  'sheets_dependencies.model_scenario': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Model what-if scenario',
  },
  ...
  'sheets_dependencies.create_scenario_sheet': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Create scenario as new sheet',
  },
  ...
  'sheets_composite.audit_sheet': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Audit sheet quality',
  },
  ...
  'sheets_composite.generate_sheet': {
    ...
    category: ScopeCategory.DRIVE_FILE,
    description: 'Generate sheet from description',
  },
  'sheets_composite.generate_template': {
    ...
    category: ScopeCategory.DRIVE_FILE,
    description: 'Generate sheet template',
  },
  ...
  'sheets_composite.build_dashboard': {
    ...
    category: ScopeCategory.DRIVE_FILE,
    description: 'Build dashboard from data',
  },
  ...
  'sheets_composite.migrate_spreadsheet': {
    ...
    category: ScopeCategory.DRIVE_FILE,
    description: 'Migrate spreadsheet to new location',
  },
  ...
  'sheets_webhook.watch_changes': {
    required: ['https://www.googleapis.com/auth/drive'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Watch for spreadsheet changes',
  },
  ...
  'sheets_webhook.unsubscribe_workspace': {
    required: ['https://www.googleapis.com/auth/drive'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Unsubscribe from workspace',
  },
  ...
  'sheets_appsscript.run': {
    required: ['https://www.googleapis.com/auth/script.scripts'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Run Apps Script function',
  },
  'sheets_appsscript.create_trigger': {
    required: ['https://www.googleapis.com/auth/script.projects'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Create Apps Script trigger',
  },
  'sheets_appsscript.list_triggers': {
    required: ['https://www.googleapis.com/auth/script.projects'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'List Apps Script triggers',
  },
  'sheets_appsscript.delete_trigger': {
    required: ['https://www.googleapis.com/auth/script.projects'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Delete Apps Script trigger',
  },
  'sheets_appsscript.update_trigger': {
    required: ['https://www.googleapis.com/auth/script.projects'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Update Apps Script trigger',
  },
  'sheets_appsscript.install_serval_function': {
    required: ['https://www.googleapis.com/auth/script.projects'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Install Serval custom function',
  },
  ...
  'sheets_auth.setup_feature': {
    required: [],
    category: ScopeCategory.SPREADSHEET,
    description: 'Setup feature with required scopes',
  },
  ...
  'sheets_session.execute_pipeline': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Execute operation pipeline',
  },

  // Agent operations - execute plans and operations
  'sheets_agent.plan': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Plan multi-step operations',
  },
  ...
  'sheets_agent.observe': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Observe plan progress',
  },
  'sheets_agent.rollback': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Rollback plan execution',
  },
  'sheets_agent.get_status': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Get agent operation status',
  },
  ...
  'sheets_agent.resume': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Resume paused plan',
  },

  // Compute operations - read-only calculations
  'sheets_compute.evaluate': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Evaluate formula without writing',
  },
  ...
  'sheets_compute.pivot_compute': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Compute pivot table',
  },
  'sheets_compute.custom_function': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Evaluate custom expression',
  },
  'sheets_compute.batch_compute': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Batch compute multiple operations',
  },
  'sheets_compute.explain_formula': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Explain formula logic',
  },
  ...
  'sheets_compute.sql_join': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Join data using SQL',
  },
  ...
  'sheets_compute.pandas_profile': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Generate pandas data profile',
  },
  ...
  'sheets_compute.matplotlib_chart': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Generate chart with matplotlib',
  },

  // Connectors - external API operations
  ...
  'sheets_connectors.query': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Query via connector',
  },
  'sheets_connectors.batch_query': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Batch query via connectors',
  },
  'sheets_connectors.subscribe': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Subscribe to connector updates',
  },
  'sheets_connectors.unsubscribe': {
    required: ['https://www.googleapis.com/auth/spreadsheets'],
    category: ScopeCategory.SPREADSHEET,
    description: 'Unsubscribe from connector',
  },
  'sheets_connectors.list_subscriptions': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'List connector subscriptions',
  },
  'sheets_connectors.transform': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Transform connector data',
  },
  ...
  'sheets_connectors.discover': {
    required: ['https://www.googleapis.com/auth/spreadsheets.readonly'],
    category: ScopeCategory.READONLY,
    description: 'Discover connector capabilities',
  },

  // Federation - access remote servers and spreadsheets
  'sheets_federation.call_remote': {
    required: ['https://www.googleapis.com/auth/drive'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Call remote MCP server',
  },
  'sheets_federation.list_servers': {
    required: ['https://www.googleapis.com/auth/drive'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'List federated servers',
  },
  'sheets_federation.get_server_tools': {
    required: ['https://www.googleapis.com/auth/drive'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Get tools from federated server',
  },
  'sheets_federation.validate_connection': {
    required: ['https://www.googleapis.com/auth/drive'],
    category: ScopeCategory.DRIVE_FULL,
    description: 'Validate federation connection',
  },
};
