...
const ConflictActionSchema = z.discriminatedUnion('action', [
  z.object({
    action: z.literal('detect'),
    spreadsheetId: z.string().min(1).describe('Spreadsheet ID to check for conflicts'),
