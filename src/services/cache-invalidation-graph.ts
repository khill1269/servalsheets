...
export class CacheInvalidationGraph {
  ...
  private buildInvalidationRules(): InvalidationRules {
    ...
    // ========================================================================
    // Burn-down: rules added to close the 171-gap KNOWN_MISSING allowlist.
    // Follow-up to e544e19d. See scripts/check-cache-invalidation-coverage.mjs
    // for the previous allowlist (now cleared).
    // ========================================================================
    rules['sheets_advanced.add_banding'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.add_drive_chip'] = { invalidates: ['values:*'] };
    rules['sheets_advanced.add_named_range'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.add_person_chip'] = { invalidates: ['values:*'] };
    rules['sheets_advanced.add_protected_range'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.add_rich_link_chip'] = { invalidates: ['values:*'] };
    rules['sheets_advanced.create_named_function'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.delete_banding'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.delete_metadata'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.delete_named_function'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.delete_named_range'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.delete_protected_range'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.get_metadata'] = { invalidates: [] };
    rules['sheets_advanced.get_named_function'] = { invalidates: [] };
    rules['sheets_advanced.get_named_range'] = { invalidates: [] };
    rules['sheets_advanced.list_banding'] = { invalidates: [] };
    rules['sheets_advanced.list_chips'] = { invalidates: [] };
    rules['sheets_advanced.list_named_functions'] = { invalidates: [] };
    rules['sheets_advanced.list_named_ranges'] = { invalidates: [] };
    rules['sheets_advanced.list_protected_ranges'] = { invalidates: [] };
    rules['sheets_advanced.list_tables'] = { invalidates: [] };
    rules['sheets_advanced.set_metadata'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.update_banding'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.update_named_function'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.update_named_range'] = { invalidates: ['metadata:*'] };
    rules['sheets_advanced.update_protected_range'] = { invalidates: ['metadata:*'] };
    rules['sheets_analyze.cancel_intelligence'] = { invalidates: [] };
    rules['sheets_analyze.formula_health_check'] = { invalidates: [] };
    rules['sheets_analyze.get_intelligence_report'] = { invalidates: [] };
    rules['sheets_analyze.schedule_intelligence'] = { invalidates: [] };
    rules['sheets_appsscript.create_trigger'] = { invalidates: ['metadata:*'] };
    rules['sheets_appsscript.delete_trigger'] = { invalidates: ['metadata:*'] };
    rules['sheets_appsscript.install_serval_function'] = { invalidates: ['metadata:*'] };
    rules['sheets_appsscript.list_triggers'] = { invalidates: [] };
    rules['sheets_appsscript.update_trigger'] = { invalidates: ['metadata:*'] };
    rules['sheets_auth.callback'] = { invalidates: [] };
    rules['sheets_auth.login'] = { invalidates: [] };
    rules['sheets_auth.logout'] = { invalidates: [] };
    rules['sheets_auth.setup_feature'] = { invalidates: [] };
    rules['sheets_bigquery.connect_looker'] = { invalidates: ['metadata:*'] };
    rules['sheets_bigquery.create_scheduled_query'] = { invalidates: ['metadata:*'] };
    rules['sheets_bigquery.delete_scheduled_query'] = { invalidates: ['metadata:*'] };
    rules['sheets_bigquery.get_connection'] = { invalidates: [] };
    rules['sheets_bigquery.get_table_schema'] = { invalidates: [] };
    rules['sheets_bigquery.import_from_bigquery'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_bigquery.list_scheduled_queries'] = { invalidates: [] };
    rules['sheets_bigquery.preview'] = { invalidates: [] };
    rules['sheets_collaborate.approval_approve'] = { invalidates: [] };
    rules['sheets_collaborate.approval_cancel'] = { invalidates: [] };
    rules['sheets_collaborate.approval_create'] = { invalidates: [] };
    rules['sheets_collaborate.approval_delegate'] = { invalidates: [] };
    rules['sheets_collaborate.approval_get_status'] = { invalidates: [] };
    rules['sheets_collaborate.approval_list_pending'] = { invalidates: [] };
    rules['sheets_collaborate.approval_reject'] = { invalidates: [] };
    rules['sheets_collaborate.label_apply'] = { invalidates: [] };
    rules['sheets_collaborate.label_list'] = { invalidates: [] };
    rules['sheets_collaborate.label_remove'] = { invalidates: [] };
    rules['sheets_collaborate.list_access_proposals'] = { invalidates: [] };
    rules['sheets_collaborate.resolve_access_proposal'] = { invalidates: [] };
    rules['sheets_collaborate.share_add'] = { invalidates: [] };
    rules['sheets_collaborate.share_get'] = { invalidates: [] };
    rules['sheets_collaborate.share_get_link'] = { invalidates: [] };
    rules['sheets_collaborate.share_list'] = { invalidates: [] };
    rules['sheets_collaborate.share_remove'] = { invalidates: [] };
    rules['sheets_collaborate.share_set_link'] = { invalidates: [] };
    rules['sheets_collaborate.share_transfer_ownership'] = { invalidates: [] };
    rules['sheets_collaborate.share_update'] = { invalidates: [] };
    rules['sheets_collaborate.version_compare'] = { invalidates: [] };
    rules['sheets_collaborate.version_create_snapshot'] = { invalidates: [] };
    rules['sheets_collaborate.version_delete_snapshot'] = { invalidates: [] };
    rules['sheets_collaborate.version_export'] = { invalidates: [] };
    rules['sheets_collaborate.version_get_revision'] = { invalidates: [] };
    rules['sheets_collaborate.version_keep_revision'] = { invalidates: [] };
    rules['sheets_collaborate.version_list_revisions'] = { invalidates: [] };
    rules['sheets_collaborate.version_list_snapshots'] = { invalidates: [] };
    rules['sheets_collaborate.version_restore_revision'] = { invalidates: ['*'], cascade: true };
    rules['sheets_collaborate.version_restore_snapshot'] = { invalidates: ['*'], cascade: true };
    rules['sheets_collaborate.version_snapshot_status'] = { invalidates: [] };
    rules['sheets_composite.batch_operations'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_composite.build_dashboard'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_compute.matplotlib_chart'] = { invalidates: [] };
    rules['sheets_compute.pandas_profile'] = { invalidates: [] };
    rules['sheets_compute.python_eval'] = { invalidates: [] };
    rules['sheets_compute.sklearn_model'] = { invalidates: [] };
    rules['sheets_compute.sql_join'] = { invalidates: [] };
    rules['sheets_compute.sql_query'] = { invalidates: [] };
    rules['sheets_confirm.get_stats'] = { invalidates: [] };
    rules['sheets_confirm.request'] = { invalidates: [] };
    rules['sheets_confirm.wizard_complete'] = { invalidates: [] };
    rules['sheets_confirm.wizard_start'] = { invalidates: [] };
    rules['sheets_confirm.wizard_step'] = { invalidates: [] };
    rules['sheets_connectors.batch_query'] = { invalidates: [] };
    rules['sheets_connectors.configure'] = { invalidates: ['metadata:*'] };
    rules['sheets_connectors.discover'] = { invalidates: [] };
    rules['sheets_connectors.list_connectors'] = { invalidates: [] };
    rules['sheets_connectors.list_subscriptions'] = { invalidates: [] };
    rules['sheets_connectors.query'] = { invalidates: [] };
    rules['sheets_connectors.status'] = { invalidates: [] };
    rules['sheets_connectors.subscribe'] = { invalidates: ['metadata:*'] };
    rules['sheets_connectors.transform'] = { invalidates: [] };
    rules['sheets_connectors.unsubscribe'] = { invalidates: ['metadata:*'] };
    rules['sheets_core.batch_get'] = { invalidates: [] };
    rules['sheets_core.describe_workbook'] = { invalidates: [] };
    rules['sheets_core.get_comprehensive'] = { invalidates: [] };
    rules['sheets_core.get_url'] = { invalidates: [] };
    rules['sheets_core.workbook_fingerprint'] = { invalidates: [] };
    rules['sheets_data.add_note'] = { invalidates: ['metadata:*'] };
    rules['sheets_data.get_merges'] = { invalidates: [] };
    rules['sheets_data.get_note'] = { invalidates: [] };
    rules['sheets_data.merge_cells'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_data.smart_fill'] = { invalidates: ['values:*'] };
    rules['sheets_data.unmerge_cells'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_dimensions.append'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_dimensions.clear_basic_filter'] = { invalidates: ['metadata:*'] };
    rules['sheets_dimensions.create_filter_view'] = { invalidates: ['metadata:*'] };
    rules['sheets_dimensions.delete'] = { invalidates: ['values:*', 'metadata:*'], cascade: true };
    rules['sheets_dimensions.delete_duplicates'] = { invalidates: ['values:*'] };
    rules['sheets_dimensions.delete_filter_view'] = { invalidates: ['metadata:*'] };
    rules['sheets_dimensions.duplicate_filter_view'] = { invalidates: ['metadata:*'] };
    rules['sheets_dimensions.freeze'] = { invalidates: ['metadata:*'] };
    rules['sheets_dimensions.get_basic_filter'] = { invalidates: [] };
    rules['sheets_dimensions.get_filter_view'] = { invalidates: [] };
    rules['sheets_dimensions.group'] = { invalidates: ['metadata:*'] };
    rules['sheets_dimensions.hide'] = { invalidates: ['metadata:*'] };
    rules['sheets_dimensions.insert'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_dimensions.list_filter_views'] = { invalidates: [] };
    rules['sheets_dimensions.move'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_dimensions.randomize_range'] = { invalidates: ['values:*'] };
    rules['sheets_dimensions.resize'] = { invalidates: ['metadata:*'] };
    rules['sheets_dimensions.set_basic_filter'] = { invalidates: ['metadata:*'] };
    ...
    rules['sheets_dimensions.ungroup'] = { invalidates: ['metadata:*'] };
    rules['sheets_dimensions.update_filter_view'] = { invalidates: ['metadata:*'] };
    rules['sheets_federation.get_server_tools'] = { invalidates: [] };
    rules['sheets_federation.validate_connection'] = { invalidates: [] };
    rules['sheets_format.apply_preset'] = { invalidates: ['metadata:*'] };
    rules['sheets_format.auto_fit'] = { invalidates: ['metadata:*'] };
    rules['sheets_format.clear_data_validation'] = { invalidates: ['metadata:*'] };
    rules['sheets_format.list_data_validations'] = { invalidates: [] };
    rules['sheets_format.set_alignment'] = { invalidates: ['metadata:*'] };
    rules['sheets_format.set_data_validation'] = { invalidates: ['metadata:*'] };
    rules['sheets_format.set_rich_text'] = { invalidates: ['values:*'] };
    rules['sheets_format.set_text_format'] = { invalidates: ['metadata:*'] };
    rules['sheets_format.sparkline_add'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_format.sparkline_clear'] = { invalidates: ['values:*', 'metadata:*'] };
    rules['sheets_format.sparkline_get'] = { invalidates: [] };
    rules['sheets_quality.analyze_impact'] = { invalidates: [] };
    rules['sheets_quality.detect_conflicts'] = { invalidates: [] };
    rules['sheets_quality.resolve_conflict'] = { invalidates: ['values:*'] };
    rules['sheets_templates.import_builtin'] = { invalidates: [] };
    rules['sheets_transaction.list'] = { invalidates: [] };
    rules['sheets_transaction.queue'] = { invalidates: [] };
    rules['sheets_transaction.status'] = { invalidates: [] };
    rules['sheets_visualize.chart_add_trendline'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.chart_create'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.chart_delete'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.chart_get'] = { invalidates: [] };
    rules['sheets_visualize.chart_list'] = { invalidates: [] };
    rules['sheets_visualize.chart_move'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.chart_remove_trendline'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.chart_resize'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.chart_update'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.chart_update_data_range'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.pivot_create'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.pivot_delete'] = { invalidates: ['metadata:*'] };
    rules['sheets_visualize.pivot_get'] = { invalidates: [] };
    rules['sheets_visualize.pivot_list'] = { invalidates: [] };
    rules['sheets_visualize.pivot_refresh'] = { invalidates: ['values:*'] };
    rules['sheets_visualize.pivot_update'] = { invalidates: ['metadata:*'] };
