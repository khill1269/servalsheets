...
export function getRelatedTools(tool: string, action: string): string[] {
  const relatedMap: Record<string, string[]> = {
    'sheets_values:read': ['sheets_values:batch_read', 'sheets_analysis:data_quality', 'sheets_analysis:statistics'],
    'sheets_values:write': ['sheets_format:apply_preset', 'sheets_values:batch_write', 'sheets_versions:create_snapshot'],
