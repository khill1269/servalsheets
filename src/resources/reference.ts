...
export function registerReferenceResources(server: McpServer): void {
  ...
  server.registerResource(
    ...
    async (uri) =>
      readReferenceResource(typeof uri === "string" ? uri : uri.toString()),
  );
  ...
  server.registerResource(
    ...
    {
      description:
        "API quotas, rate limits, and size restrictions for Google Sheets operations.",
      mimeType: "application/json",
    },
    async (uri) =>
      readReferenceResource(typeof uri === "string" ? uri : uri.toString()),
  ...
  server.registerResource(
    ...
    {
      description:
        "Common validation rules for emails, URLs, phone numbers, and custom patterns.",
      mimeType: "application/json",
    },
    async (uri) =>
      readReferenceResource(typeof uri === "string" ? uri : uri.toString()),
            ...
            text: JSON.stringify(
              {
                ...
                conversion: {
                  ...
                  example:
                    "RGB(128, 64, 192) → {red: 0.502, green: 0.251, blue: 0.753}",
                },
              },
              null,
              2,
            ...
            text: JSON.stringify(
              {
                basic: {
                  line: {
                    ...
                    dataRequirements:
                      "X-axis (categories/dates), Y-axis (values)",
