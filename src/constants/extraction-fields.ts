...
export type TestCategory =
  // Structural Domain (15 categories)
  | "sheet_count"
  | "sheet_names"
  | "sheet_order"
  | "hidden_sheets"
  ...
  | "pivot_tables"
  | "charts"
  // Formatting Domain (10 categories)
  | "font_styles"
  | "cell_colors"
  | "borders"
  | "number_formats"
  ...
  | "cell_padding"
  | "text_rotation"
  // Collaboration Domain (6 categories)
  | "sharing_permissions"
  | "edit_history"
  | "comments"
  | "suggested_edits"
 ...
 */
export const TIER_MINIMAL: TierConfig = {
  tier: "MINIMAL",
 ...
 */
export const TIER_FORMATTING: TierConfig = {
  tier: "FORMATTING",
 ...
 */
export const TIER_DATA_COMPLETE: TierConfig = {
  tier: "DATA_COMPLETE",
 ...
 */
export const TIER_COLLABORATION: TierConfig = {
  tier: "COLLABORATION",
 ...
 */
export const TIER_COMPREHENSIVE: TierConfig = {
  tier: "COMPREHENSIVE",
 ...
 */
export const EXTRACTION_TIERS: Record<ExtractionTier, TierConfig> = {
 ...
 */
export const CATEGORY_TO_TIER: Record<TestCategory, ExtractionTier> = {
 ...
 */
export const DOMAIN_CATEGORIES: Record<TestDomain, TestCategory[]> = {
  structural: [
    "sheet_count",
    "sheet_names",
    "sheet_order",
 ...
 */
export function getCategoriesForDomain(domain: TestDomain): TestCategory[] {
 ...
 */
export function getCategoriesForDomains(domains: TestDomain[]): TestCategory[] {
 ...
 */
export function getTierForCategory(category: TestCategory): TierConfig {
 ...
 */
export function mergeFieldMasks(tiers: ExtractionTier[]): string {
 ...
 */
export function getMinTTL(tiers: ExtractionTier[]): number {
 ...
 */
export function requiresGridData(tiers: ExtractionTier[]): boolean {
 ...
 */
export function getCategoryCounts(): Record<TestDomain, number> {
  return {
 ...
 */
export function isValidCategory(category: string): category is TestCategory {
 ...
 */
export function isValidDomain(domain: string): domain is TestDomain {
...
export function getAllCategories(): TestCategory[] {
  return Object.keys(CATEGORY_TO_TIER) as TestCategory[];
}

/**
 * Get all test domains
 */
export function getAllDomains(): TestDomain[] {
  return Object.keys(DOMAIN_CATEGORIES) as TestDomain[];
}
